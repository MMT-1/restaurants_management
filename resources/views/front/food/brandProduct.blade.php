...
@section('title') Brand Food @endsection
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <div class="single-item">
                                    <div class="image-area">
                                        <a href="{{route('food.single',array('id'=>$item->id,'slug'=>$item->food_slug))}}">
                                            <img src="{{asset('owner/food/'.$item->image)}}" class="img-active" alt="food Image"/>
                                        </a>
                                        <a href="{{route('food.single',array('id'=>$item->id,'slug'=>$item->food_slug))}}">
                                            <img src="{{asset('owner/food/'.$item->image)}}" class="img-hover" alt="food Image"/>
                                        </a>
                                    ...
                                    <div class="bottom-area">
                                        ...
                                        <a href="{{route('food.single',array('id'=>$item->id,'slug'=>$item->food_slug))}}" class="add-cart button-style1">read more <span class="btn-dot"></span></a>
                                    </div>
                                </div>
                            </div>
                            @empty
