...
@section('title') food Details @endsection
        ...
        <div class="row">
            <div class="col-lg-5 col-md-6">
                <div class="image-area">
                    <div class="img-gallery">
                        <div class="item">
                            <img id="zoom_01" src="{{asset('owner/food/'.$food->image)}}" alt="food" data-zoom-image="{{asset('owner/food/'.$food->image)}}">
                        </div>
                        {{-- <div class="item">
                            <img id="zoom_02" src="{{asset('front/assets/images/shop/shop2.jpg')}}" alt="food" data-zoom-image="{{asset('front/assets/images/shop/shop2.jpg')}}">
                        </div>
                        <div class="item">
                            <img id="zoom_03" src="{{asset('front/assets/images/shop/shop3.jpg')}}" alt="food" data-zoom-image="{{asset('front/assets/images/shop/shop3.jpg')}}">
                        </div>
                        <div class="item">
                            <img id="zoom_04" src="{{asset('front/assets/images/shop/shop4.jpg')}}" alt="food" data-zoom-image="{{asset('front/assets/images/shop/shop4.jpg')}}">
                        </div> --}}
                    </div>
                    <div class="img-thumb">
                        <div class="item">
                        ...
                        {{-- <div class="item">
                            <img src="{{asset('front/assets/images/shop/shop-sm2.jpg')}}" alt="food">
                        </div>
                        <div class="item">
                            <img src="{{asset('front/assets/images/shop/shop-sm3.jpg')}}" alt="food">
                        </div>
                        <div class="item">
                            <img src="{{asset('front/assets/images/shop/shop-sm4.jpg')}}" alt="food">
                        </div> --}}
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-7 col-md-6">
                ...
                <div class="detail-content">
                    <span class="stock">@if($food->stock_status==1) in stock @else Out of stock @endif </span>
                    ...
                    @if($attributeType->count()>0)
                      @else 
                      <h4>{{number_format($food->sale_price)}} – @if($food->regular_price>0)<span>{{number_format($food->regular_price)}}</span>@endif</h4>
                     @endif
                    <p class="desc">{{$food->short_description}}</p>
                    @foreach($food->foodAttributeValue as $value) 
                    ...
                    <div class="border-area">
                        <div class="cart-part d-flex align-items-center">
                            <div class="d-flex number-spinner">
                                ...
                                <input type="number" name="quantity" class="form-control text-center input-value" value="1" min="1">
                                <div class="buttons">
                            ...
                            <!-- <button type="submit"   item.add class="cart button-style1">add to cart <span class="btn-dot"></span></button> -->
                            <a href="{{route('add.wishlist',$food->id)}}" class="add-more"><i class="far fa-heart"></i></a>
                            <button href="{{route('add.cart',$food->id)}}"  class="add-more"><i class="btn-dot"></i></button>
                            <!-- <button type="submit"  class="add-more">dus<i class="btn-dot"></i></button> -->
                            ...
                            <div class="col-lg-7">
                                <ul class="comment">
                                    <li class="item d-flex">
                                        <div class="image">
                                            <a href="#!">
                                                <img src="{{asset('front/assets/images/restaurant/review1.jpg')}}" alt="Review Image">
                                            </a>
                                        </div>
                                    ...
                                    <li class="item d-flex">
                                        <div class="image">
                                            <a href="#!">
                                                <img src="{{asset('front/assets/images/restaurant/review2.jpg')}}" alt="Review Image">
                                            </a>
                                        </div>
                                        <div class="media-body">
                                            <ul class="rating d-flex">
                ...
                <div class="row featured-slider">
                    <div class="col-lg-3">
                        <div class="single-product">
                            <div class="image-area">
                                <img src="{{asset('front/assets/images/home1/featured/p1a.jpg')}}" class="img-main" alt="food Image"/>
                                <img src="{{asset('front/assets/images/home1/featured/p1b.jpg')}}" class="img-hover" alt="food Image"/>
                    ...
                    <div class="col-lg-3">
                        <div class="single-product">
                            <div class="image-area">
                                <img src="{{asset('front/assets/images/home1/featured/p2a.jpg')}}" class="img-main" alt="food Image"/>
                                <img src="{{asset('front/assets/images/home1/featured/p2b.jpg')}}" class="img-hover" alt="food Image"/>
                                <span class="sale-status">sale</span>
                                <div class="action">
                                    <ul class="d-flex">
                                        <li>
                    ...
                    <div class="col-lg-3">
                        <div class="single-food">
                            <div class="image-area">
                                <img src="{{asset('front/assets/images/home1/featured/p3a.jpg')}}" class="img-main" alt="food Image"/>
                                <img src="{{asset('front/assets/images/home1/featured/p3b.jpg')}}" class="img-hover" alt="food Image"/>
                    ...
                    <div class="col-lg-3">
                        <div class="single-product">
                            <div class="image-area">
                                <img src="{{asset('front/assets/images/home1/featured/p4a.jpg')}}" class="img-main" alt="food Image"/>
                                <img src="{{asset('front/assets/images/home1/featured/p4b.jpg')}}" class="img-hover" alt="food Image"/>
                                <span class="sale-status">sale</span>
                                <div class="action">
                                    <ul class="d-flex">
                                        <li>
