                                                        ...
                                                        <div class="css-125s5yu eytdi1r3">
                                                            <div class="css-1fh8qjj e1xxesyf0">
                                                                <div data-test="restaurant-card-image" class="css-1e38alf eytdi1r2">
                                                                    <img alt="" src="{{ asset('owner/restaurant/'.$restaurant->logo) }}" class="eb34jsh0 css-1qrxtxt eb34jsh1 img-fluid" />
                                                                </div>
                                                                <div class="css-4sye6w elkhwc30">
                                                                    <h3 color="special.black" class="css-bue2rm eytdi1r1">
                                                                        <a href="{{ route('restaurant.single', ['id' => $restaurant->id, 'slug' => $restaurant->restaurant_slug]) }}">
                                                                            {{ $restaurant->restaurant_name }}
                                                                        </a>
                                                                    </h3>
                                                                    <div data-test="restaurant-card-rating" class="css-1hw2w72 eytdi1r0">
                                                                        <span class="css-l7ijkl ezjtbe50"><span>Score:</span></span>
                                                                        <span>8.2</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="css-lbwht3 eulusyj0">
                                                                <div class="css-1ycoc1n e1xxesyf0">
                                                                    <p data-testid="tags-layout" class="css-zmb4ti eulusyj0">
                                                                        <span font-weight="m" data-test="thefork-pay-tag" alt="PAY" display="inline-block" color="information" class="css-11lskvk e6i9wrr1">
                                                                ...
                                                                <p data-test="restaurant-card-average-price" class="css-lbwht3 eulusyj0">
                                                                    <span>€30 average price</span>
                                                                </p>
                                                            </div>
                                                            <p class="css-537ftl eulusyj0">
                                                                <span display="inline-block" data-test="restaurant-card-discount" class="css-1rhev5r e1ffw3qu0">-30%</span>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
