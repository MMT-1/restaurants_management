...
<header>
    ...
    <header class="css-mwcv66 eqdhima3 fixed-top">
        <div class="css-1v8u8fq elkhwc30">
                ...
                <div data-testid="header-logo-link" class="css-1jhwvdw ehfrn900">
                    <a href="https://www.thefork.com/">
                        <div class="css-16zivgd e1tpugp10">
                            ...
                            <svg width="48" height="48" viewBox="0 0 40 40" aria-hidden="true" focusable="false"
                                class="e1tpugp12 css-1rgpkae e1yfthn30">
                                <path transform="translate(3.25,0)"
                                    d="M17.4.67h-1.41v15.04h1.4V.67zM20.87 1.07l-1.4-.22V15.5l1.4-.28V1.07zM13.88.85l-1.4.22v14.15l1.4.28V.85zM15.04 37.01c.06-.92.12-2.44.12-2.93 0-.49.04-.52-.09-2.01-.12-1.5-.3-2.05-.4-2.66-.09-.6-.27-1.28-.54-2.2-.28-.91-.52-1.37-.89-2.22-.4-.86-1.07-2.08-1.74-3.27a13.4 13.4 0 01-1.46-3.9 20.01 20.01 0 01-.18-4.34c.06-1 .2-3.53.33-4.88C4.12 10.95 0 16.5 0 23.04c0 8.11 6.53 14.8 14.92 15.62l.12-1.65zM18.34 37.01c-.06-.92-.12-2.44-.12-2.93 0-.49-.03-.52.09-2.01.12-1.5.3-2.05.4-2.66.09-.6.27-1.28.54-2.2.28-.91.52-1.37.89-2.22.4-.86 1.07-2.08 1.74-3.27a13.4 13.4 0 001.46-3.9c.28-1.56.25-3.36.18-4.34-.03-1-.2-3.53-.33-4.88 6.01 2.38 10.16 7.9 10.16 14.44 0 8.11-6.53 14.8-14.92 15.62 0 0-.03-.73-.1-1.65z">
                                </path>
                            </svg>
                        </div>
                                                ...
                                                <div class="d-flex position-relative cart-product-img">
                                                    ...
                                                    <div class="text ms-3">
                                                        <a href="shop-detail-left.html">
                                                            <h5>{{$item->product->product_name}}dfaaaaaaaaaaaaaaa</h5>
                                                        </a>
                                                        @if(isset($item->attributeType))
            ...
            <span class="nav-item dropdown position-relative">
                    ...
                    <img class="user-avatar -medium" src="{{ asset('vendor/profile/'.Auth::guard('vendor')->user()->image) }}">
                    </a>
    ...
    @if (Route::currentRouteName() == 'shop.single' || Route::currentRouteName() == 'restaurants.nearby')
    <div data-test="header-content" class="css-1eszyna eqdhima1 my-3">

                <div data-test="search-component" class="styles_formHorizontal___DjRa"><div class="css-1sn0ou2 elkhwc30"><div class="styles_inputContainer__oP8eT"><div class="styles_header__LvEz8"><div class="styles_titleBar__faw9q"><span><span>What</span></span><button class="styles_iconCross__sHcI3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" aria-hidden="true" focusable="false" class="css-p3qwn0 e7tclca0"><path fill-rule="evenodd" d="m12 10.94 6.22-6.22a.75.75 0 0 1 1.147.956l-.087.104L13.06 12l6.22 6.22a.75.75 0 0 1-.956 1.147l-.104-.087L12 13.06l-6.22 6.22a.75.75 0 0 1-1.147-.956l.087-.104L10.94 12 4.72 5.78a.75.75 0 0 1 .956-1.147l.104.087L12 10.94Z"></path></svg></button></div><label color="gray.xl" display="block" for="whatinput" class="css-14l0plx eulusyj0"><span><span>What</span></span></label><span class="styles_wrapper__yAYpU styles_searchInputWrapper__VlR2_ styles_what__1qWvW"><span class="styles_inputLine__o5Lpc styles_hasBorder__RBeU2 styles_search__tjTV0 styles_searchInput__u_8Vt"><span role="button" tabindex="0" class="styles_prefix__FlGY7"><span class="styles_searchIcon__ureZe"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" aria-hidden="true" focusable="false" class="css-p3qwn0 elml5ar0"><g fill-rule="evenodd"><path d="M16.91 1.5C19.181 1.5 21 4.068 21 6.616c0 2.083-1.32 3.496-3.273 3.802V21.59a.91.91 0 1 1-1.819 0V10.418c-1.952-.306-3.09-1.719-3.09-3.802 0-2.548 1.819-5.116 4.091-5.116Zm0 1.467c-1.174 0-2.455 1.81-2.455 3.65 0 1.546.96 2.395 2.454 2.395 1.494 0 2.455-.849 2.455-2.396 0-1.839-1.282-3.649-2.455-3.649Z"></path><path d="M7.09 21.766c0 .406-.365.734-.817.734-.452 0-.818-.328-.818-.734V9.728C4.095 9.728 3 8.723 3 7.492V2.234c0-.406.366-.734.818-.734.452 0 .818.328.818.734v5.258c0 .428.371.769.819.769V2.234c0-.406.366-.734.818-.734.452 0 .818.328.818.734V8.26c.447 0 .818-.34.818-.769V2.234c0-.406.366-.734.818-.734.452 0 .818.328.818.734v5.258c0 1.231-1.094 2.236-2.454 2.236v12.038Z"></path></g></svg></span></span><label class="styles_labelWrapper__Ce7TK"><span class="styles_inputWrapper__eMJ2o styles_search__tjTV0"><input type="search" class="styles_input__vCYji" name="search" placeholder="Cuisine, restaurant name..." id="whatinput" autocomplete="off" aria-owns="autocomplete" aria-autocomplete="both" aria-activedescendant="option1" data-hj-whitelist="true" data-test="search-what-input" label="" inputplacement="default" notice="" value=""></span></label></span></span></div></div></div><div class="css-uzcusv elkhwc30"><div class="styles_inputContainer__oP8eT"><div class="styles_header__LvEz8"><div class="styles_titleBar__faw9q"><span>Where</span><button class="styles_iconCross__sHcI3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" aria-hidden="true" focusable="false" class="css-p3qwn0 e7tclca0"><path fill-rule="evenodd" d="m12 10.94 6.22-6.22a.75.75 0 0 1 1.147.956l-.087.104L13.06 12l6.22 6.22a.75.75 0 0 1-.956 1.147l-.104-.087L12 13.06l-6.22 6.22a.75.75 0 0 1-1.147-.956l.087-.104L10.94 12 4.72 5.78a.75.75 0 0 1 .956-1.147l.104.087L12 10.94Z"></path></svg></button></div><label color="gray.xl" display="block" for="whereinput" class="css-14l0plx eulusyj0"><span>Where</span></label><span class="styles_wrapper__yAYpU styles_searchInputWrapper__VlR2_ styles_where__NUu9b"><span class="styles_inputLine__o5Lpc styles_hasBorder__RBeU2 styles_search__tjTV0 styles_searchInput__u_8Vt"><span role="button" tabindex="0" class="styles_prefix__FlGY7"><span class="styles_searchIcon__ureZe"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" aria-hidden="true" focusable="false" class="css-p3qwn0 e3pjkim0"><g fill-rule="evenodd"><path d="M12 1.5a6.75 6.75 0 0 1 6.75 6.75c0 .82-.146 1.62-.413 2.324-.775 2.588-2.671 6.43-5.69 11.557a.75.75 0 0 1-1.293 0c-3.02-5.127-4.916-8.97-5.675-11.51A6.75 6.75 0 0 1 12 1.5ZM12 3a5.25 5.25 0 0 0-5.25 5.25c0 .639.114 1.26.35 1.892.673 2.249 2.294 5.605 4.856 10.045l.043.073.43-.746c2.229-3.912 3.69-6.942 4.389-9.101l.099-.318A5.25 5.25 0 0 0 12 3Z"></path><path d="M12 5.25a3 3 0 1 1 0 6 3 3 0 0 1 0-6Zm0 1.5a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3Z"></path></g></svg></span></span><label class="styles_labelWrapper__Ce7TK"><span class="styles_inputWrapper__eMJ2o styles_search__tjTV0"><input type="search" class="styles_input__vCYji styles_hasValue__KXB2d" name="search" placeholder="Near me, exact address, station..." id="whereinput" autocomplete="off" aria-owns="autocomplete" aria-autocomplete="both" aria-activedescendant="option1" data-hj-whitelist="true" data-test="search-where-input" label="" inputplacement="default" notice="" value="Madrid">
                
                </span></label></span></span></div></div></div><div class="css-iehb9x elkhwc30"><button height="40px" type="submit" class="css-m60cff ektx8jp0"><span>Search</span></button>
            </div></div>            </div>
                    @endif
