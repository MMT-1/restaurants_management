...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="card mb-3">
                <div class="card-body">
                       <form method="post" action="{{route('restaurant.foods')}}" enctype="multipart/form-data">
                         @csrf 
                         <div class="row">
                           <div class="col-md-9">
                             ...
                             <div class="form-group">
                              <label>food Description <span class="text-danger">*</span></label>
                               <textarea class="form-control" cols="5" rows="5" name="long_description" placeholder="food Description"></textarea>
                             ...
                             <div class="form-group mt-3">
                              <label>Short Description <span class="text-danger">*</span></label>
                               <textarea class="form-control" cols="5" rows="5" name="short_description" placeholder="food Short Description"></textarea>
