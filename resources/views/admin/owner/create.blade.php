                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <input class="form-control" name="restaurant_name" type="text" value="{{old('restaurant_name')}}" placeholder="restaurant Name"  />
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="restaurant_address" placeholder="Enter restaurant Address" value="{{old('restaurant_address')}}"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
