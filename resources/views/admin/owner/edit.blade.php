                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="first_name" type="text"
                                                            value="{{ $owner->first_name }}" placeholder="First Name" />
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="last_name" type="text"
                                                            value="{{ $owner->last_name }}" placeholder="Last Name" />
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="email" type="email"
                                                            value="{{ $owner->email }}" placeholder="Email" />
                                                        @if ($errors->has('email'))
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="country_id">
                                                            @foreach ($country as $countrys)
                                                                ...
                                                                @endif
                                                                <option value="{{ $countrys->id }}" {{ $select }}>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <input class="form-control" name="mobile" type="text"
                                                                value="{{ $owner->mobile }}" placeholder="Mobile" />
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <input class="form-control" name="restaurant_name"
                                                                type="text"
                                                                value="{{ optional($owner->restaurants)->restaurant_name }}"
                                                                placeholder="restaurant Name" />
                                                            @if ($errors->has('restaurant_name'))
                                                                <span class="text-danger">
                                                                    {{ $errors->first('restaurant_name') }}</span>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-12">
                                                    ...
                                                    <input type="hidden" id="latitude" name="latitude"
                                                        value="{{ optional($owner->restaurants)->latitude }}">
                                                    <input type="hidden" id="longitude" name="longitude"
                                                        value="{{ optional($owner->restaurants)->longitude }}">
                                                    <div class="form-group">

                                                        <input type="text" class="form-control"
                                                            style="position:relative" name="location" id="location"
                                                            value="{{ optional($owner->restaurants)->restaurant_address }}" />


                                                    </div>
                                                    <div id="map"
                                                        style="width:100%;height:300px;position:relative  padding-top: 20px;">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 col-xl-3">
                                        ...
                                        <div class="card mb-3">
                                            <div class="card-body text-center">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <button type="submit" class="btn btn-info btn-block mt-3"> <i
                                        ...
                                        <div class="card mb-3">
                                            ...
                                            <div class="card-body text-center">
                                                <img class="mb-2" src="{{ asset('owner/profile/' . $owner->image) }}"
                                                    width="200" height="200" alt="owner profile">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                        ...
                                        <div class="card mb-3">
                                            ...
                                            <div class="card-body text-center">
                                                <img class="mb-2"
                                                    src="{{ asset('owner/restaurant/' . optional($owner->restaurants)->logo) }}"
                                                    width="200" height="200" alt="owner profile">
                                                <div class="row">
                                                    <div class="col-lg-12">
