...
@section('content')
<!-- <form method="POST" action="{{ route('vendor.vendorProfile.update') }}">
    @csrf
    <div class="form-group">
        <label for="first_name">First Name</label>
        <input type="text" class="form-control" id="first_name" name="first_name" value="{{ $vendor->first_name }}" required>
    </div>
    <div class="form-group">
        <label for="last_name">Last Name</label>
        <input type="text" class="form-control" id="last_name" name="last_name" value="{{ $vendor->last_name }}" required>
    </div>
    <div class="form-group">
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="card mb-3 ">
                  <div class="card-body">
                    <form action="{{ route('vendor.vendorProfile.update') }}" method="post" enctype="multipart/form-data">
                        @csrf 
                        <div class="row">
